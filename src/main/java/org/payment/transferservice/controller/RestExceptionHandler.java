package org.payment.transferservice.controller;

import static org.springframework.http.HttpStatus.BAD_REQUEST;
import static org.springframework.http.HttpStatus.INTERNAL_SERVER_ERROR;
import static org.springframework.http.HttpStatus.NOT_FOUND;

import org.payment.transferservice.dto.ApiErrorResponse;
import org.payment.transferservice.exception.NotFoundException;
import org.payment.transferservice.metric.MetricsService;
...
public class RestExceptionHandler {
    ...
    private static String getRequestIdentifier(ServletRequest request) {
        return (String) request.getAttribute(DepositController.REQUEST_UID);
    }
}
